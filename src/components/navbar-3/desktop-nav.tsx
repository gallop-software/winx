                  ...
                  <PopoverButton
                    className={clsx(
                      callToAction
                        ...
                        : clsx(
                            'flex h-full cursor-pointer items-center px-4 py-2 text-base font-body font-medium bg-blend-multiply focus:outline-none rounded-lg',
                            dark
            ...
            <Link
              ...
              className={clsx(
                callToAction
                  ...
                  : clsx(
                      'flex items-center px-4 py-2 text-base font-body font-medium bg-blend-multiply rounded-lg',
                      dark
                        ? 'text-body hover:bg-body/10'
