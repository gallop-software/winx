                      ...
                      className={clsx(
                        callToAction
                          ? clsx(
                              ...
                              'pl-6 pr-4 py-2 text-sm font-medium',
                              'bg-contrast-dark text-body hover:bg-contrast',
                              'transition-colors duration-200 cursor-pointer',
                              'focus:outline-none'
                            )
                          : 'flex w-full items-center justify-between text-base font-body font-medium text-contrast focus:outline-none py-2 cursor-pointer pr-2'
                      )}
                    >
                      {label}
                      <Icon
                ...
                <Link
                  ...
                  className={clsx(
                    callToAction
                      ...
                      : 'text-base block font-body font-medium text-contrast py-2 px-0'
                  )}
                >
                  {label}
                </Link>
